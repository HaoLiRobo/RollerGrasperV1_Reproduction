...
int paramSequence[5][8] = {{0,0,0,0,0,105,110,105}, {180,0,0,0,0,105,110,105},{180,180,-180,0,0,100,115,100},{0,180,-180,0,0,100,115,100},{0,0,0,0,0,105,110,105}};
...
void setup() {
  ...
  for(int i=0;i<3;i++)
  {
    ...
    jointInputs[1][0]= 105 * DEG2BIT;//83
    jointInputs[1][1]= 110* DEG2BIT;//85
    jointInputs[1][2]= 105* DEG2BIT;//90
