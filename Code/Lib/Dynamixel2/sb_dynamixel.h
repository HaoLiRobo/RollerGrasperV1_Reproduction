...
#define DYNAMIXEL_BAUD 1000000 //1000000 // default value is 57600, but want to increase this
#define DYNAMIXEL_SERIAL Serial1
#define DYNAMIXEL_IO_SELECT 2
...
class SB_Dynamixel 
{
  public:
    ...
    SB_Dynamixel(unsigned char device_id, int curr_pos, short goalCurrent, int goalPosition, int last_position);
    void init();
